var canvasPanel = function(){
    ...
    this.img1 = new Image();
    this.img1.src="./images/temperImg/glassBody.png";
   	this.img=new Image();
    this.img.src="./images/temperImg/glassBottom12.png";
    this.current = 50;
    this.timer = null;
}
canvasPanel.prototype.init =function(canvasId){
    ...
    var img2 = new Image();
    img2.src="./images/temperImg/glassTop.png";
...
canvasPanel.prototype.paintBottom = function(){
	...
	if(!$this.img1.complete){
    	...
    	$this.context.drawImage($this.img1,52*$this.times,13*$this.times,34*$this.times,130*$this.times);//ˮ������������
    }
	$this.context.drawImage($this.img,45*$this.times,143*$this.times,48*$this.times,52*$this.times);//����ˮ�����岿��
        
    $this.context.beginPath(); 
    $this.context.fillStyle=$this.bgColor;/*����ˮ���������ɫ*/ 
    $this.context.fillRect(60*$this.times,142*$this.times,19*$this.times,12*$this.times);/*����һ�����Σ�ǰ��������������ʼλ�ã��������ֱ��Ǿ��εĿ�͸�*/
    $this.context.closePath(); 
