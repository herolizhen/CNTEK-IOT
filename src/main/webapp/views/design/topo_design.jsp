...
<body class="easyui-layout" style="width:100%;height:100%;">
	...
	<div region="west" split="true" style="width:200px;">
		<div title="工具箱" class="easyui-panel" id="ToolMenu"
			style="border:none;overflow: hidden;" fit="true">
			<ul style="width:100%;height:100%;" id="controlNameBox">
				<li data-cIndex='2'><img
					src="<%=basePath%>/views/design/images/icons/text.png"
					class="CNicons" alt=""> <a id="a_2" class=" controlName"
					group="">静态标签</a></li>
				<li data-cIndex='5'><img
					src="<%=basePath%>/views/design/images/icons/info.png"
					class="CNicons" alt=""> <a id="a_5" class=" controlName"
					group="">监测点信息</a></li>
				<li data-cIndex='11'><img
					src="<%=basePath%>/views/design/images/icons/button.png"
					class="CNicons" alt=""> <a id="a_11" class=" controlName"
					group="">控制按钮</a></li>
				<li data-cIndex='8'><img
					src="<%=basePath%>/views/design/images/icons/switch.png"
					class="CNicons" alt=""> <a id="a_8" class=" controlName"
					group="">开关量</a></li>
				<li data-cIndex='14'><img
					src="<%=basePath%>/views/design/images/icons/dash.png"
					class="CNicons" alt=""> <a id="a_14" class=" controlName"
					group="">表盘</a></li>
				<li data-cIndex='15'><img
					src="<%=basePath%>/views/design/images/icons/termometer.png"
					class="CNicons" alt=""> <a id="a_15" class=" controlName"
					group="">刻度表</a></li>
<!-- 				<li data-cIndex='16'><img -->
<%-- 					src="<%=basePath%>/views/design/images/icons/door.png" --%>
<!-- 					class="CNicons" alt=""> <a id="a_16" class=" controlName" -->
<!-- 					group="">门禁</a></li> -->
<!-- 				<li data-cIndex='20'><img -->
<%-- 					src="<%=basePath%>/views/design/images/icons/panel.png" --%>
<!-- 					class="CNicons" alt=""> <a id="a_20" class=" controlName" -->
<!-- 					group="">分组面板</a></li> -->
				<li data-cIndex='24'><img
					src="<%=basePath%>/views/design/images/icons/chart.png"
					class="CNicons" alt=""> <a id="a_24" class=" controlName"
					group="">图表控件</a></li>
			</ul>
		</div>
	</div>
	<div region="center" split="true">
		<div id="centerTabs" class="easyui-tabs"
			...
			<div title="组态图设计" id="contentBox" data-options="closable:false"
				style="padding:4px;position:relative;">
				<div id="resizeBox"
					style="position:relative;width:100%;height:100%;z-index:2;border:1px solid #ccc;overflow:hidden;"
					data-Box="bgBox"></div>
			</div>
	...
	<div region="east" split="true" style="width:280px;" collapsed='false'
		title="属性|背景" id="eastBox">
		<div class="panel" style="width:100%; left: 976px; top: 29px;">
			<div id="dv_property">
				<table id="t_property" cellpadding="1" cellspacing="1">
					<tbody>
						<tr class="static">
							<td colspan="3"><select autocomplete="off" id="selele"
								name="selele" onclick="chg_selele()" style=" width:120px;">
									<option data-Id="bg" value="bg">背景</option>
							</select> <input type="button" value="删除" id="deleAttr"> <input
								type="button" value="保存" id="saveAttr"></td>
						</tr>
						...
						<tr id="tr_i_x" class="static">
							...
							<td class="txt"><input id="i_x" name="x" class="input0"
								value="0" style="width:150px;"> px</td>
						</tr>
						<tr id="tr_i_y" class="static">
							<td></td>
							<td class="txt i_attrName">Y</td>
							<td class="txt"><input id="i_y" name="y" class="input0"
								value="0" style="width:150px;"> px</td>
						</tr>
						<tr id="tr_i_w" class="static">
							<td></td>
							<td class="txt i_attrName">宽度</td>
							<td class="txt"><input id="i_w" name="w" class="input0"
								value="20" style="width:150px;"> px</td>
						</tr>
						<tr id="tr_i_h" class="static">
							<td></td>
							<td class="txt i_attrName">高度</td>
							<td class="txt"><input id="i_h" name="h" class="input0"
								value="20" style="width:150px;"> px</td>
						</tr>
						...
						<tr id="tr_i_borderwidth" class="static">
							...
							<td class="txt"><input id="i_borderwidth" name="borderWidth"
								class="input0" style="width:150px;"> px</td>
						</tr>
						<tr id="tr_i_padding" class="static">
							<td></td>
							<td class="txt i_attrName">边距</td>
							<td class="txt"><input id="i_padding" name="padding"
								style="width:150px;"> px</td>
						</tr>
						<tr id="tr_i_bordercolor" class="static">
							<td></td>
							<td class="txt i_attrName">边框颜色</td>
							<td class="txt"><input type="text" class="colorPicker"
								id="i_bordercolor" name="borderColor" value="#ccc"></td>
						</tr>
						...
						<tr id="tr_i_panelColor" style="display:none;">
							...
							<td class="txt input0"><input type="text"
								class="colorPicker" name="panelColor" id="i_panelColor"
								value="#fff"></td>
						</tr>
						<tr id="tr_i_alpanelColor" style="display:none;">
							...
							<td class="txt input0"><input type="text"
								class="colorPicker" name="alpanelColor" id="i_alpanelColor"
								value="#fff"></td>
						</tr>
						...
						<tr id="tr_i_deviceid" style="display:none;">
							...
							<td class="txt"><input id="i_deviceid" name="devname"
								class="input0" value="" style="width:150px;"></td>
						</tr>
						<tr id="tr_i_moniShowMode" style="display:none;">
							<td></td>
							<td class="txt i_attrName">显示模式</td>
							<td class="txt"><select id="i_moniShowMode"
								name="moniShowMode">
						...
						<tr id="tr_i_devnameShowMode" style="display:none;">
							...
							<td class="txt"><select id="i_devnameShowMode"
								name="devnameShowMode">
						...
						<tr id="tr_i_linkjson" style=" display:none;">
							...
							<td class="txt"><input id="i_linkjson" class="input0"
						...
						<tr id="tr_i_DoorState" style=" display:none;">
							...
							<td class="txt"><input type="text" id="i_DoorState"
								name="DoorState" style="width:150px;"></td>
						</tr>
						<tr id="tr_i_OpenStateValue" style=" display:none;">
							<td></td>
							<td class="txt i_attrName">门打开值</td>
							<td class="txt"><select id="i_OpenStateValue"
								name="openValue">
						...
						<tr id="tr_i_inverse" style=" display:none;">
							...
							<td class="txt"><input type="checkbox" id="i_inverse"
								name="inverse" value="0" style="vertical-align: middle;" /> 反选
							</td>
						</tr>
						<tr id="tr_i_alarmMaxValue" style="display:none;">
							<td></td>
							<td class="txt i_attrName">告警上限</td>
							<td class="txt"><input type="text" id="i_alarmMaxValue"
								name="alarmMaxValue" style="width:150px;"></td>
						</tr>
						<tr id="tr_i_alarmMinValue" style="display:none;">
							<td></td>
							<td class="txt i_attrName">告警下限</td>
							<td class="txt"><input type="text" id="i_alarmMinValue"
								name="alarmMinValue" style="width:150px;"></td>
						</tr>
						...
						<tr id="tr_i_photochgtime" style=" display:none;">
							...
							<td class="txt"><input id="i_photochgtime" class="input0"
								value="" style="width:150px;"></td>
						</tr>
						<tr id="tr_i_photourl" style=" display:none;">
							<td></td>
							<td class="txt i_attrName">照片路径</td>
							<td class="txt"><input id="i_photourl" class="input0"
								value="" style="width:150px;"></td>
						</tr>
						<tr id="tr_i_photoindex" style=" display:none;">
							<td></td>
							<td class="txt i_attrName">索引号</td>
							<td class="txt"><input id="i_photoindex" class="input0"
								value="" style="width:150px;"></td>
						</tr>
						...
						<tr id="tr_i_txtauto" style=" display:none;">
							...
							<td class="txt"><select id="i_txtauto"
								onchange="i_txtauto_chg()">
									<option value="1">是</option>
									<option value="0">否</option>
							</select></td>
						</tr>
						<tr id="tr_i_alarmimgurl" style=" display:none;">
							...
							<td class="txt"><input id="i_alarmimgurl" class="input0"
								value="" style="width:150px;"></td>
						</tr>
						<tr id="tr_i_userDefinde" style="display:none;">
							<td></td>
							<td class="txt i_attrName">自定义器件名称</td>
							<td class="txt"><input type="text" id="i_userDefinde"
								name="userDefinde" style="width:150px;"></td>
						</tr>
						...
						<tr id="tr_i_dopenimgurl" style="display:none;">
							...
							<td class="txt"><input id="i_dopenimgurl" name="openImgurl"
								class="input0" value="" style="width:150px;"></td>
						</tr>
						<tr id="tr_i_dcloseimgurl" style="display:none;">
							<td></td>
							<td class="txt i_attrName">值为1时图片</td>
							<td class="txt"><input id="i_dcloseimgurl"
								name="closeImgurl" class="input0" value="" style="width:150px;">
							</td>
						</tr>
						<tr id="tr_i_bj" style="display: none;">
							<td></td>
							<td class="txt i_attrName">背景图片</td>
							<td class="txt"><input id="i_bj" name="bgImg" class="input0"
						...
						<tr id="tr_i_dopenText" style="display:none;">
							...
							<td class="txt"><input id="i_dopenText" name="openText"
								class="input0" value="打开" style="width:150px;"></td>
						</tr>
						<tr id="tr_i_dcloseText" style="display:none;">
							<td></td>
							<td class="txt i_attrName">值为1时文本</td>
							<td class="txt"><input id="i_dcloseText" name="closeText"
								class="input0" value="关闭" style="width:150px;"></td>
						</tr>
						<tr id="tr_i_tagtext" style=" display:none;">
							<td></td>
							<td class="txt i_attrName">文本</td>
							<td class="txt"><input id="i_tagtext" name="tagtext"
								class="input0" style="width:150px;"></td>
						</tr>
							...
							<td colspan="2">
								<table id="table_font" cellpadding="0" cellspacing="0">
									<tr id="tr_i_fontFamily" class="fontStyle">
										...
										<td class="txt"><select id="i_fontFamily"
											name="fontFamily">
									...
									<tr id="tr_i_textWeight" class="fontStyle">
										...
										<td class="txt"><select id="i_textWeight"
											name="fontWeight">
												<option value="normal">正常</option>
									...
									<tr id="tr_i_fontSize" class="fontStyle">
										...
										<td class="txt"><input type="text" id="i_fontSize"
											name="fontSize" value="14" style="width:150px;"> px</td>
									</tr>
									<tr id="tr_i_fontColor" class="fontStyle">

										<td class="txt fontTxt i_attrName">文本颜色</td>
										<td class="txt"><input type="text" class="colorPicker"
											id="i_fontColor" name="fontColor" value="#333"
											style="width:150px;"></td>
									</tr>
								</table>
							</td>
						...
						<tr id="tr_i_linkorgidstatus" style=" display:none;">
							...
							<td class="txt"><select id="i_linkorgidstatus"
								name="linkorgidstatus">
									<option value="0">否</option>
									<option value="1">是</option>
							</select></td>
						</tr>
...
<!-- 						</tr> -->
						<tr id="tr_i_moniDevId" style="display:none;">
							...
							<td class="txt input0"><input type="text" id="i_moniDevId"
								name="moniDevId" style="width:150px;"></td>
						</tr>
...
<!-- 						</tr> -->
						<tr id="tr_i_bjcolor" style="display: none;">
							...
							<td class="txt"><input id="i_bjcolor" name="bgColor"
								type="text" class="colorPicker marker"
								value="rgba(255,255,255,0)" style="width:150px;"></td>
						</tr>
						<tr id="tr_i_alarmbjcolor" style="display: none;">
							<td></td>
							<td class="txt i_attrName">告警背景色</td>
							<td class="txt"><input id="i_alarmbjcolor" name="albgColor"
								type="text" class="colorPicker marker"
								value="rgba(255,255,255,0)" style="width:150px;"></td>
						</tr>
						<tr id="tr_i_titleText" style=" display:none;">
							...
							<td class="txt">
								<input id="i_titleText" name="titleText" style="width:150px;">
							</td>
						</tr>
						...
						<tr id="tr_i_chartSplit" style=" display:none;">
							...
							<td class="txt"><input type="text" id="i_chartSplit"
								name="chartSplit"></td>
						</tr>
						<tr id="tr_i_addMoniState" style=" display:none;">
							<td></td>
							<td class="txt i_attrName">添加监测点</td>
							<td class="txt"><input id="i_addMoniState"
								name="addMoniState" style="width:150px;"></td>
						</tr>
						<tr id="tr_i_chartcolor" style="display: none;">
							<td></td>
							<td class="txt i_attrName">图例颜色</td>
							<td class="txt"><input id="i_chartcolor" name="chartcolor"
								type="text" class="colorPicker marker" value="rgba(0,0,0,1)"
								style="width:150px;"></td>
						</tr>
						<tr id="tr_i_charttext" style="display: none;">
							<td></td>
							<td class="txt i_attrName">标记点文本</td>
							<td class="txt"><input id="i_charttext" name="charttext"
								type="text" style="width:150px;"></td>
						</tr>
						<tr id="tr_i_devlevel" class="static" style=" display:none;">
							<td></td>
							<td class="txt i_attrName">层级调整</td>
							<td class="txt input0"><select name="devlevel"
								id="i_devlevel">
