...
<body>
	<div class="modal fade" id="infoModal" tabindex="-1" role="dialog" aria-labelledby="infoLabel" aria-hidden="true" data-backdrop="static">
		<div class="modal-dialog" style="width:600px">
			<div class="modal-content">
				...
				<form id="infoForm" name="infoForm" class="form-horizontal" role="form" novalidate="novalidate">
					...
					<div class="modal-body row">
						...
						<div class="col-xs-8">
							<label class="radio-inline"> <input type="radio" name="isRecovery" id="isRecovery0">否
							</label> <label class="radio-inline"> <input type="radio" name="isRecovery" id="isRecovery1">是
							</label>
						</div>
					</div>
					<!-- 					<div class="modal-body row"> -->
	...
	<div class="container-fluid div_dev">
		<div class="page-header">
			<h3>
				DTU管理 <small>台账管理，设备基础台账维护（设备激活后自动注册）</small>
			</h3>
		</div>
		<div id="infoToolbar">
