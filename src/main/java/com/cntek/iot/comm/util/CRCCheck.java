package com.cntek.iot.comm.util;
...
public class CRCCheck {
	...
	public static boolean checkHexString(String hexString) {
		CRCCheck crc16 = new CRCCheck();
		byte[] bb = HexString2Buf(hexString);
		crc16.update(bb, bb.length - 2);
		int ri = crc16.getValue();
		if (bb[bb.length - 1] == (byte) (ri & 0xff) && bb[bb.length - 2] == (byte) ((0xff00 & ri) >> 8))
			return true;
	...
	public static void main(String[] args) {
		...
		byte[] sbuf = CRCCheck.getSendBuf("01031000D100C89C400001008C00000D0A0CAF4A96");
		System.out.println(CRCCheck.checkHexString("01031000D100C89C400001008C00000D0A0CAF4A96"));
		System.out.println(CRCCheck.checkBuf(sbuf));
	}
