...
//	private static String broker = "tcp://localhost:1883";
	...
	private static String passWord = "8848";
...
//		connOpts.setServerURIs(uris);  //起到负载均衡和高可用的作用
	...
	private static void publish(String str, String clientId, String topic) throws MqttException {
		...
		if (mqttClient != null) {
			...
			System.out.println("pub-->" + mqttClient.getClientId());
		}
...
//		}
	...
	public static void main(String[] args) throws MqttException {
		for (int i = 0; i < 40000; i++) {
			publish("message content", "client-id-" + i, "d2c.cff7d7d9-3999-4780-b255-b583d17b3d33.status");
		}
	}
}
