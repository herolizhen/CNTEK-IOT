...
(function (w) {
    ...
    api.fromUnixtime = function (unixtime) {
    ...
    api.saveApps = function (applist) {
    	var data = {};
    	data.applist = applist;
    	setStorage(APPLIST, data);
    };
    api.getApps = function () {
    	return getStorage(APPLIST);
    };
    ...
    api.setParameters = function (data) {
    	return setStorage(_Parameters, data);
    };
    api.getParameters = function () {
    	return getStorage(_Parameters);
    };
    ...
    api.getFuncHeight = function () {
		if (!api.isNull(w.parent)) {
			var h = $(w.parent.document).find('#func-frame').height();
			return h;
		}
	};
	...
	api.minuteToDateString = function(min) {
